  ...
  window.synchronizeFields(formGroups.typeForPrice, formGroups.pricePerNightField, typeOfHousingName, typeOfHousingFieldCount, 'value');

  window.synchronizeFields(formGroups.dateOfStayStart, formGroups.dateOfStayEnd, dateOfStayStartCount, dateOfStayEndCount, 'value');

  window.synchronizeFields(formGroups.numberOfRoomsFiled, formGroups.numberOfSeatsField, numberOfRoomsFiledCount, numberOfSeatsFieldCount, 'value');
